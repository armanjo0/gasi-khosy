...
const menuData = [
    ...
    items: [
      ...
      },
      {
        ...
        note: {
          ...
          ar: 'بيتزا دجاج، شاورما لحم، بارد فريش',
          ku: 'یەک پیتزای مریشک، یەک شاورمەی گۆشت، یەک ساردی فرێش',
        },
        price: '10.000',
      ...
      },
      {
        ...
        note: {
          ...
          ar: 'همبرگر لحم، شاورما دجاج، شاورما لحم، بيبسي قوطي',
          ku: 'یەک هەمبەرگەری گۆشت، یەک شاورمەی مریشک، یەک شاورمەی گۆشت، یەک ببسی قوتو',
        },
        price: '10.000',
      ...
      },
      {
        ...
        note: {
          ...
          ar: 'تمن وفاصوليا ساده، شاورما لحم، شاورما دجاج، بيبسي قوطي، لبن شنينة',
          ku: 'برنج و فاسۆلیای سادە، یەک شاورمەی گۆشت، یەک شاورمەی مریشک، یەک ببسی قوتو، یەک ماستاو',
        },
        price: '11.000',
  ...
  },
  {
    ...
    icon: '🥙',
    items: [
      { name: { en: 'Beef Shawarma', ar: 'شاورما لحم', ku: 'شاورمەی گۆشت' }, price: '4.000', image: 'assets/images/beef-shawarma-samoon.webp' },
      { name: { en: 'Chicken Shawarma', ar: 'شاورما دجاج', ku: 'شاورمەی مریشك' }, price: '2.000', image: 'assets/images/chicken-shawarma-samoon.webp' },
      ...
      { name: { en: 'Cheese Chicken Burger', ar: 'جيز برگر دجاج', ku: 'چیز بەرگەر مریشك' }, price: '3.500', image: 'assets/images/chicken-burger.webp' },
      {
        ...
        note: {
          ...
          ar: 'شاورما لحم، بطاطا، زيتون، سلطة',
          ku: 'شاورمەی گۆشت، فینگر، زەیتون، زەڵاتە',
        },
        price: '6.000',
      ...
      },
      {
        ...
        note: {
          ...
          ar: 'شاورما دجاج، بطاطا، زيتون، سلطة',
          ku: 'شاورمەی مریشك، فینگر، زەیتون، زەڵاتە',
        },
        price: '5.000',
  ...
  },
  {
    ...
    icon: '🥩',
    items: [
      { name: { en: 'Half Portion Beef Shawarma', ar: 'نص نفر شاورما لحم', ku: 'نیو نەفەر شاورمەی گۆشت' }, price: '8.000', image: 'assets/images/beef-shawarma-half.webp' },
      { name: { en: 'Full Portion Beef Shawarma', ar: 'نفر كامل شاورما لحم', ku: 'یەك نەفەر شاورمەی گۆشت' }, price: '15.000', image: 'assets/images/beef-shawarma-full.webp' },
      { name: { en: '1 Kilo Beef Shawarma', ar: 'واحد كيلو شاورما لحم', ku: 'یەك کیلۆ شاورمەی گۆشت' }, price: '45.000', image: 'assets/images/beef-shawarma-kilo.webp' },
      { name: { en: 'Half Portion Chicken Shawarma', ar: 'نص نفر شاورما دجاج', ku: 'نیو نەفەر شاورمەی مریشك' }, price: '7.000', image: 'assets/images/chicken-shawarma-half.webp' },
      { name: { en: 'Full Portion Chicken Shawarma', ar: 'نفر كامل شاورما دجاج', ku: 'یەك نەفەر شاورمەی مریشك' }, price: '14.000', image: 'assets/images/chicken-shawarma-full.webp' },
      { name: { en: '1 Kilo Chicken Shawarma', ar: 'واحد كيلو شاورما دجاج', ku: 'یەك کیلۆ شاورمەی مریشك' }, price: '30.000', image: 'assets/images/chicken-shawarma-kilo.webp' },
    ],
  },
  {
    id: 'pizza',
