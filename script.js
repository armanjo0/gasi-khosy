...
const menuData = [
  ...
  },
  {
    ...
    icon: '🥙',
    items: [
      { name: { en: 'Beef Shawarma', ar: 'گص لحم', ku: 'گەص گۆشت' }, price: '4.000', image: 'assets/images/low/beef-shawarma-samoon.webp' },
      { name: { en: 'Chicken Shawarma', ar: 'گص دجاج', ku: 'گەص مریشك' }, price: '3.000', image: 'assets/images/low/chicken-shawarma-samoon.webp' },
      { name: { en: 'Beef Burger', ar: 'همبرگر لحم', ku: 'هەمبەرگری گۆشت' }, price: '4.000', image: 'assets/images/low/beef-burger.webp' },
      { name: { en: 'Chicken Burger', ar: 'همبرگر دجاج', ku: 'هەمبەرگری مریشك' }, price: '3.000', image: 'assets/images/low/chicken-burger.webp' },
      { name: { en: 'Cheese Beef Burger', ar: 'جيز برگر لحم', ku: 'چیز بەرگەر گۆشت' }, price: '4.500', image: 'assets/images/low/beef-burger.webp' },
      { name: { en: 'Cheese Chicken Burger', ar: 'جيز برگر دجاج', ku: 'چیز بەرگەر مریشك' }, price: '3.500', image: 'assets/images/low/chicken-burger.webp' },
      {
        ...
        price: '6.000',
        image: 'assets/images/low/beef-saj.webp',
      },
      {
        ...
        price: '5.000',
        image: 'assets/images/low/chicken-saj.webp',
      },
      { name: { en: 'Meat Pastry (Lahm Bi Ajeen)', ar: 'لحم بالعجين', ku: 'لحم بالعجین' }, price: '4.000', image: 'assets/images/low/meat-pastry.webp' },
      { name: { en: 'Meat Pastry with Cheese', ar: 'لحم بالعجين مع الجبن', ku: 'لحم بالعجین لەگەڵ پەنیر' }, price: '5.000', image: 'assets/images/low/meat-pastry-cheese.webp' },
    ],
  },
  {
    id: 'extras',
    ...
    icon: '🍟',
    items: [
      { name: { en: 'fries', ar: 'فنگر', ku: 'فینگەر' }, price: '3.000', image: 'assets/images/low/fries.webp' },
      { name: { en: 'Nuggets (6 pcs)', ar: 'ناگيت (كنتاكي) 6 عدد', ku: 'ناگێت (کنتاکی) ٦ دانە' }, price: '4.000', image: 'assets/images/low/nuggets.webp' },
      { name: { en: 'Small Appetizer Platter', ar: 'مقبلات صغيرة', ku: 'موقەمبیلات بچووك' }, price: '3.000', image: 'assets/images/low/appetizer.webp' },
      { name: { en: 'Large Appetizer Platter', ar: 'مقبلات كبيرة', ku: 'موقەمبیلات گەورە' }, price: '5.000', image: 'assets/images/low/appetizer.webp' },
    ],
  },
  {
    id: 'cold-drinks',
    ...
    icon: '🥤',
    items: [
      { name: { en: 'Fresh Pepsi', ar: 'بيبسي فريش', ku: 'بێبسی فرێش' }, price: '1.500', image: 'assets/images/low/fresh-pepsi.webp' },
      { name: { en: 'Canned Soft Drink', ar: 'بارد قواطي', ku: 'ساردی قوتی' }, price: '1.000', image: 'assets/images/low/canned-soft-drink.webp' },
      { name: { en: 'Ayran (Yogurt Drink)', ar: 'لبن شنينة', ku: 'ماستاو' }, price: '1.000', image: 'assets/images/low/ayran.webp' },
      { name: { en: 'Coffee', ar: 'كوفي (قهوة)', ku: 'کۆفی (قاوە)' }, price: '2.000', image: 'assets/images/low/coffee.webp' },
    ],
  },
  {
    id: 'meat-portions',
    ...
    icon: '🥩',
    items: [
      { name: { en: 'Half Portion Beef Shawarma', ar: 'نص نفر گص لحم', ku: 'نیو نەفەر گەص گۆشت' }, price: '8.000', image: 'assets/images/low/beef-shawarma-half.webp' },
      { name: { en: 'Full Portion Beef Shawarma', ar: 'نفر كامل گص لحم', ku: 'یەك نەفەر گەص گۆشت' }, price: '15.000', image: 'assets/images/low/beef-shawarma-full.webp' },
      { name: { en: '1 Kilo Beef Shawarma', ar: 'واحد كيلو گص لحم', ku: 'یەك کیلۆ گەص گۆشت' }, price: '45.000', image: 'assets/images/low/beef-shawarma-kilo.webp' },
      { name: { en: 'Half Portion Chicken Shawarma', ar: 'نص نفر گص دجاج', ku: 'نیو نەفەر گەص مریشك' }, price: '7.000', image: 'assets/images/low/chicken-shawarma-half.webp' },
      { name: { en: 'Full Portion Chicken Shawarma', ar: 'نفر كامل گص دجاج', ku: 'یەك نەفەر گەص مریشك' }, price: '14.000', image: 'assets/images/low/chicken-shawarma-full.webp' },
      { name: { en: '1 Kilo Chicken Shawarma', ar: 'واحد كيلو گص دجاج', ku: 'یەك کیلۆ گەص مریشك' }, price: '30.000', image: 'assets/images/low/chicken-shawarma-kilo.webp' },
    ],
  },
  {
    id: 'pizza',
    ...
    icon: '🍕',
    items: [
      { name: { en: 'Mixed Pizza', ar: 'بيتزا مشكل', ku: 'پیتزای موشەکەل' }, price: '8.000', image: 'assets/images/low/pizza-mixed.webp' },
      { name: { en: 'Beef Pizza', ar: 'بيتزا لحم', ku: 'پیتزای گۆشت' }, price: '8.000', image: 'assets/images/low/pizza-beaf.webp' },
      { name: { en: 'Chicken Pizza', ar: 'بيتزا دجاج', ku: 'پیتزای مریشك' }, price: '7.000', image: 'assets/images/low/pizza-chicken.webp' },
      { name: { en: 'Pepperoni Pizza', ar: 'بيتزا بيبروني', ku: 'پیتزای پیپەرۆنی' }, price: '7.000', image: 'assets/images/low/pizza-pepperoni.webp' },
      { name: { en: 'Vegetable Pizza', ar: 'بيتزا خضروات', ku: 'پیتزای سەوزەوات' }, price: '7.000', image: 'assets/images/low/pizza-vegetable.webp' },
      { name: { en: 'Tuna Pizza', ar: 'بيتزا سمك', ku: 'پیتزای ماسی' }, price: '7.000', image: 'assets/images/low/pizza-tuna.webp' },
      { name: { en: 'Margherita Pizza', ar: 'بيتزا مارگريتا', ku: 'پیتزای مارگەریتا' }, price: '6.000', image: 'assets/images/low/pizza-margherita.webp' },
      { name: { en: 'Calzone Pizza (Closed)', ar: 'بيتزا كالزوني (مغلق)', ku: 'پیتزای کالزۆنی (داخراو)' }, price: '8.000', image: 'assets/images/low/pizza-calzone.webp' },
    ],
  },
  {
    id: 'rice',
    ...
    icon: '🍚',
    items: [
      { name: { en: 'Rice with Beans (Plain)', ar: 'تمن مع فاصوليا (ساده)', ku: 'برنجی کوردی و فاسۆلیا (سادە)' }, price: '4.000', image: 'assets/images/low/rice-beans.webp' },
      { name: { en: 'Rice & Beans with Beef Shawarma', ar: 'تمن و فاصوليا مع گص لحم', ku: 'برنجی کوردی و فاسۆلیا لەگەڵ گەص گۆشت' }, price: '7.000', image: 'assets/images/low/rice-beans-beef.webp' },
      { name: { en: 'Rice & Beans with Chicken Shawarma', ar: 'تمن و فاصوليا مع گص دجاج', ku: 'برنجی کوردی و فاسۆلیا لەگەڵ گەص مریشك' }, price: '6.000', image: 'assets/images/low/rice-beans-chicken.webp' },
    ],
  },
  {
    id: 'pasta',
    ...
    icon: '🍝',
    items: [
      { name: { en: 'Beef Pasta', ar: 'باستا لحم', ku: 'پاستای گۆشت' }, price: '6.000', image: 'assets/images/low/pasta-beef.webp' },
      { name: { en: 'Chicken Pasta', ar: 'باستا دجاج', ku: 'پاستای مریشك' }, price: '5.000', image: 'assets/images/low/pasta-chicken.webp' },
      { name: { en: 'Kapsalon', ar: 'كابسالون', ku: 'کاپسالۆن' }, price: '6.000', image: 'assets/images/low/kapsalon.webp' },
    ],
  },
];
